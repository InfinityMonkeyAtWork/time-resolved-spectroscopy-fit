...
- [x] Track v1.0.0 removal in TODO.md under "Build & release → Remove legacy/backwards-compat code." **Done. Sub-bullets added to the existing "Remove legacy/backwards-compat code" item naming `File.save_sbs_fit` / `File.save_2d_fit` (and their `_save_*_fit_legacy` impls) plus the `File.load_fit` stub.**
